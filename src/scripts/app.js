...
const SCENARIO = {
    1: [
        // Step 0: 0日目・導入 (占い店対面)
        {
            ...
            speaker: "ナレーション",
            text: "雨上がりの都会の片隅。君は道端に落ちている1枚のタロットカードを拾い上げた。描かれているのは、崖から今にも飛び出そうとしている若者――『0：愚者』。裏面には、手書きの奇妙な地図が描かれている。奇妙な引力に導かれ、その地図が指し示す路地裏へふと足を進めると、そこには古びたタロットショップの重い木製の扉があった。",
