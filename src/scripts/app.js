...
// --- Soul Cards Mapping ---
const SOUL_CARDS = {
    0: { name: "0 : 愚者", desc: "無限の可能性と無計画。あなたは常に新しい旅を求め、他者のルールに染まりやすい脆弱さを持っています。" },
    1: { name: "I : 魔術師", desc: "知恵と技術。あなたは優れた能力を持っていますが、それゆえに完璧なシステムによる統制を望んでしまうのです。" },
    2: { name: "II : 女教皇", desc: "直感と知識。あなたは真実を見通す力がありながら、自ら思考を閉ざし、静観という名の盲信を選びがちです。" },
    3: { name: "III : 女帝", desc: "豊穣と愛。あなたは物質的・精神的な満たしを求め、それを約束してくれるシステムに身を委ねてしまいます。" },
    4: { name: "IV : 皇帝", desc: "支配と社会的責任。あなたは安定した秩序を重んじるがゆえに、アプリの提示する強力なルールを歓迎します。" },
    5: { name: "V : 法王", desc: "規律と指導。あなたは正解を教えてくれる絶対的な存在を信じることで、自ら考える責任を放棄します。" },
    6: { name: "VI : 恋人たち", desc: "選択と調和。あなたは運命的な出会いや情動に流されやすく、愛のためにすべてを投げ出す危険があります。" },
    7: { name: "VII : 戦車", desc: "勝利と前進。あなたは目に見える成果を急ぐあまり、そのレールがどこへ続くかを確かめることを忘れます。" },
    8: { name: "VIII : 力", desc: "忍耐と信念。あなたは苦境に耐える強さを持っていますが、それが不条理なシステムへの服従に変わる恐れがあります。" },
    9: { name: "IX : 隠者", desc: "探求と静寂。あなたは自己の内省を深めようとしますが、孤独への恐れからシステムの灯火にすがりつきます。" },
    10: { name: "X : 運命の輪", desc: "変化と好機。あなたは状況の移り変わりに一喜一憂し、自ら車輪を回すのではなく運命任せになります。" },
    11: { name: "XI : 正義", desc: "客観性と決断。あなたは正しさに固執するあまり、冷酷な裁きを下し、孤立と罪悪感に苛まれます。" },
    12: { name: "XII : 吊られた男", desc: "試練と自己犠牲。あなたは耐えることを美徳とし、システムのために自分を犠牲にする愚行を受け入れます。" },
    13: { name: "XIII : 死神", desc: "終焉と再生。あなたは変化を恐れるあまり、終わらせるべき関係やシステムにしがみつき続けます。" },
    14: { name: "XIV : 節制", desc: "調和と純化。あなたはバランスを好みますが、それは葛藤を避けて現状維持に甘んじることでもあります。" },
    15: { name: "XV : 悪魔", desc: "束縛と物質欲。あなたは甘美な檻と依存の心地よさに完全に絡め取られ、抜け出せなくなっています。" },
    16: { name: "XVI : 塔", desc: "崩壊と劇変。あなたは積み上げた偽りが崩れ去る恐怖を知りながら、なお再建の約束をシステムに求めます。" },
    17: { name: "XVII : 星", desc: "希望と憧れ。あなたは遠い理想を夢見ながら、足元の現実を直視せず、美しい幻影を盲信します。" },
    18: { name: "XVIII : 月", desc: "不安と欺瞞。あなたは不確かさに怯え、偽りの真実を提示する占い師の言葉を鵜呑みにしてしまいます。" },
    19: { name: "XIX : 太陽", desc: "活力と祝福。あなたは明るい未来を信じて疑いませんが、それは影（シャドウ）を無視した盲目的楽観です。" },
    20: { name: "XX : 審判", desc: "復活と覚醒。あなたは過去の過ちからの救済を望み、システムの審判に自らの免罪を委ねます。" },
    21: { name: "XXI : 世界", desc: "完成と全体性。あなたは完璧な調和を求めますが、それは自律意思を失ったディストピアでの完成にすぎません。" }
};

// --- Celtic Cross Configuration ---
const CELTIC_CARDS_DATA = [
    { pos: "1. 現在の状況", name: "0 : 愚者 (正)", img: "/images/cards/0.jpg", desc: "あなたは今、盲目的に日常の旅に出発したばかりの無垢なる愚者です。", area: "present" },
    { pos: "2. 直面する障害", name: "ソードのA (正)", img: "/images/cards/swords01.jpg", desc: "【ソードの要素】理性的に切り裂こうとする意志が、逆にあなたの直感を阻む障害となっています。考えることはノイズなのです。", area: "present", rotate: true },
    { pos: "3. 意識していること", name: "カップの3 (正)", img: "/images/cards/cups03.jpg", desc: "【カップの要素】あなたは周囲との調和や仲間との楽しい時間を表面的に求めています。", area: "conscious" },
    { pos: "4. 潜在意識・根底", name: "ペンタクルの5 (逆)", img: "/images/cards/pents05.jpg", desc: "【ペンタクルの要素】物質的・精神的な欠乏感や、見捨てられることへの強い不安があなたの行動原理になっています。", area: "unconscious" },
    { pos: "5. 過去の要因", name: "ワンドの2 (正)", img: "/images/cards/wands02.jpg", desc: "【ワンドの要素】あなたはかつて野心を抱き、新たな地平へ踏み出そうと決断しました。", area: "past" },
    { pos: "6. 近い未来", name: "XV : 悪魔 (正)", img: "/images/cards/15.jpg", desc: "近い未来、あなたは甘美な依存と束縛を受け入れ、自律意思を手放すでしょう。", area: "future" },
    { pos: "7. あなたの立場", name: "ソード of 5 (正)", img: "/images/cards/swords05.jpg", desc: "【ソードの要素】あなたは利己的に勝利を収めようとして、孤独や敗北感を味わうことになります。", area: "staff-1" },
    { pos: "8. 周囲の環境", name: "カップ of 10 (正)", img: "/images/cards/cups10.jpg", desc: "【カップの要素】周囲は偽りの満ち足りた幸福感に包まれており、あなたがコミュニティに同調することを求めています。", area: "staff-2" },
    { pos: "9. 望みと恐れ", name: "ワンド of 9 (正)", img: "/images/cards/wands09.jpg", desc: "【ワンドの要素】あなたは傷つきながらも身を守ろうとし、他者を警戒しています。", area: "staff-3" },
    { pos: "10. 最終結果", name: "XXI : 世界 (正)", img: "/images/cards/21.jpg", desc: "最終的に、あなたはシステムと同調し、一切の葛藤がない『ディストピア的な完成』へと至るでしょう。", area: "staff-4" }
];
...
const MEDITATION_MOTIFS = {
    0: {
        title: "0 : 愚者",
        motifs: [
            { name: "崖の縁", text: "あなたが崖の縁に惹かれたのは、今まさに新しい一歩を踏み出したい、あるいは現状を打破したいという無意識のサインです。踏み出す前に、自分の足元を信じましょう。" },
    ...
    1: {
        title: "I : 魔術師",
        motifs: [
            { name: "無限大の記号", text: "頭上のレムニスケート（無限大）は、あなたの無限のポテンシャルを示しています。手元にはすでに必要なものが揃っています。恐れずにスタートを切りましょう。" },
            { name: "テーブルの上の道具", text: "テーブルの道具はあなたのリソースを意味します。新しいスキルを学ぶのではなく、今ある武器をどう組み合わせるかに知恵を絞りましょう。" }
        ]
    },
    2: {
        title: "II : 女教皇",
    ...
    7: {
        ...
        motifs: [
            ...
            { name: "星の天蓋", text: "戦車を覆う星の天蓋は、高い理想と目的意識を示します。目先の勝利だけでなく、あなたが本当に目指すべき高遠な目標を見据えてください。" }
        ]
    },
    9: {
        title: "IX : 隠者",
    ...
    15: {
        title: "XV : 悪魔",
        motifs: [
            { name: "緩い首輪の鎖", text: "男女の首にかかる鎖は非常に緩く、その気になればいつでも外せます。あなたが囚われている依存や悪習慣は、実は「自分の意志で囚われ続けている」だけかもしれません。" },
    ...
    16: {
        title: "XVI : 塔",
        motifs: [
            { name: "王冠を吹き飛ばす稲妻", text: "天から降る雷は、突然の天啓や予期せぬ外部からの衝撃を意味します。崩壊は苦痛ですが、それは偽りのプライドや誤った土台からあなたを解放する光でもあります。" },
    ...
    17: {
        title: "XVII : 星",
        motifs: [
            { name: "輝く大星と7つの小星", text: "大星は希望とインスピレーションの源泉です。暗闇の中でも、あなたを導くかすかな希望の光が必ず存在していることを信じてください。" },
            { name: "大地と水面に注ぐ水", text: "水を注ぐ仕草は、惜しみない分かち合いと癒やしを意味します。あなたの感情や才能を、見返りを求めずに表現してみましょう。" }
        ]
    },
    21: {
        title: "XXI : 世界",
        motifs: [
            { name: "月桂樹の輪", text: "世界を囲む輪は、旅の終着点と完璧な全体性を示します。あなたは葛藤を乗り越え、一つのサイクルを完成させました。調和と調律を祝う時です。" },
...
const SCENARIO = {
    1: [
        // Step 0: 0日目・導入 (占い店対面)
        {
            ...
            speaker: "ナレーション",
            text: "雨上がりの都会の片隅。あなたは道端に落ちている1枚のタロットカードを拾い上げた。描かれているのは、崖から今にも飛び出そうとしている若者――『0：愚者』。裏面には美しい紋章と、この先の路地裏にあるタロットショップの住所が記されている。軽い好奇心に惹かれ、あなたはショップの重い木製の扉を開けた。",
            stressChange: 0, luckChange: 0,
            cards: [
                { id: 0, title: "扉を開けて入店する", upright: true, desc: "カランコロン、とドアベルが静かに響く。店内は薄暗く、お香の甘い香りが漂っている。キャンドルの炎に照らされて座っているのは、不思議な魅力を漂わせる占い師ソフィアだった。「ようこそ、旅人さん。迷子の愚者を届けてくれてありがとう」" }
            ]
        },
        // Step 1: 0日目・シャッフル (占い店対面)
        {
            ...
            speaker: "ソフィア",
            text: "「お礼に、今のあなたの運命を1枚だけ占ってあげましょう」 ソフィアはあなたが届けた『愚者』のカードを山札に戻し、念入りにシャッフルした。裏向きに並べられた3枚のカードから、あなたが直感で引き当てたのは……",
            stressChange: -10, luckChange: 10,
            choiceIllusion: true, // Show 3 cards but result is fixed
            cards: [
                { id: 0, title: "0 : 愚者", upright: true, desc: "【正位置】無限の可能性、無垢な旅立ち。ソフィアは優しく微笑む。「あら……あなたが拾ってくれた迷子が、あなたと一緒にいたいと戻ってきたようね。カードが自ら次の旅人としてあなたを指名したのです。タロットの世界において、無知は罪ではなく、むしろ無限の可能性そのものなのよ。さあ、あなたの日常という旅を始めましょう」" }
            ]
        },
        ...
        // Step 8: 7日目・恋人たちの罠 (チャットアプリ)
        {
            ...
            cards: [
                { id: 6, title: "占いショップへ戻る (本契約)", upright: true, desc: "運命の人を失いたくない。あの幸せな体験を続けたい……。あなたは自発的な選択のつもりで、再び路地裏の占いショップへ走り出す。" },
                { id: 6, title: "アプリを削除して日常に戻る", upright: false, desc: "【分岐バッドエンド】運命の人は完全に蒸発。さらに、アプリを失った途端に職場の人間関係や仕事がドミノ倒しのように崩壊。「あのとき指示に従っていれば」という強烈な後悔に苛まれる。周囲の人間全員がアプリに依存して幸福そうな中、自分の意志を守ったあなただけが孤独に破滅していく。画面には逆位置の『愚者』が現れた。「あなたは自由を選んだ結果、誰からも導かれない本当の馬鹿になった」" }
            ]
        },
    ...
    2: [
        // Loop 2 Step 0: 既視感 (占い店対面)
        {
            ...
            speaker: "ナレーション",
            text: "……強烈な既視感がある。あなたはまたしても、あのカードを拾い、あの住所をたどり、同じ占い店の前に立っている。ソフィアは同じように座っているが、今回は何かが違う。アプリからも彼女からも『〇〇をしなさい』という具体的な命令が一切消え去っている。",
            stressChange: 0, luckChange: 0,
            cards: [
                { id: 0, title: "もう一度カードをめくる", upright: true, desc: "ソフィアは少し戸惑った様子であなたを見つめる。「ようこそ、旅人さん……。なんだか、以前にもお会いしたような……？ さあ、カードの持つ象徴だけを提示します。具体的な行動の決断は、ご自身で行ってください」" }
            ]
        },
