...
const SCENARIO = {
    1: [
        // Step 0: 0日目・導入 (占い店対面)
        {
            ...
            speaker: "ナレーション",
            text: "雨上がりの都会の片隅。君は道端に落ちている1枚のカードを拾い上げた。描かれているのは、白い薔薇を手に持ち、崖の縁から今にも踏み出そうとしている若者と、その足元で吠える犬の奇妙な絵。裏面には、手書きの奇妙な地図が描かれている。奇妙な引力に導かれ、その地図が指し示す路地裏へふと足を進めると、そこには古びたタロットショップの重い木製の扉があった。",
            stressChange: 0, luckChange: 0,
            cards: [
                { id: 0, title: "扉を開けて入店する", upright: true, desc: "カランコロン、とドアベルが静かに響く。店内は薄暗く、お香の甘い香りが漂っている。キャンドルの炎に照らされて座っているのは、不思議な魅力を漂わせる占い師ソフィアだった。君がカードを差し出すと、彼女は目を丸くした。「あら……！ これ、私がずっと探していたカードだわ。どこで見つけたの？」" }
            ]
        },
        // Step 1: 0日目・シャッフル (占い店対面)
        {
            ...
            speaker: "ソフィア",
            text: "「これは『0：愚者』のカード。描かれている若者はね、頭上を見上げて足元の崖に気づいていないの。無計画で無知に見えるけれど、先入観がなく、どんな未来へも飛び出せる『無限の可能性』そのもの。……届けてくれたお礼に、今の君の運命を1枚だけ占ってあげましょう」 ソフィアは君が届けたカードを山札に戻し、念入りにシャッフルした。裏向きに並べられた3枚のカードから、君が直感で引き当てたのは……",
